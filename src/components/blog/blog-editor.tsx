...
const formSchema = z.object({
  ...
  excerpt: z.string().min(20, 'Excerpt must be at least 20 characters.').max(200, 'Excerpt cannot be more than 200 characters.'),
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-8">
                    ...
                    render={({field}) => (
                        ...
                        <FormControl>
                            <Input placeholder="Enter a compelling title" {...field} onChange={handleTitleChange} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                    ...
                    render={({field}) => (
                        ...
                        <FormDescription>This is the part of the URL that identifies your post.</FormDescription>
                        <FormMessage />
                        </FormItem>
                    )}
                    />
